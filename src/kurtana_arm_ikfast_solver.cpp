...
///
/// ikfast version 61 generated on 2013-06-06 09:49:14.507521
/// To compile with gcc:
///     gcc -lstdc++ ik.cpp
...
eetrans[2]=((((x5)*(((((x1)*(x13)))+(((IkReal(0.184600000000000))*(x21)))))))+(((IkReal(0.190000000000000))*(x3)))+(((x7)*(((((IkReal(-0.184600000000000))*(x19)))+(((x13)*(x3)))))))+(((IkReal(0.139000000000000))*(x23)))+(((IkReal(0.139000000000000))*(x21))));
